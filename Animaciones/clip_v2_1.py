...
class Escena:
    ...
    def actualizar(self):
        ...
        # actualizamos la puntuacion considerando la frecuencia de tuberias y el estado del jugador
...
class Tuberias:
    ...
    def __init__(self, x=BG_H):
        ...
        # elegimos aleatoriamente el sentido de la velocidad vertical UPDATE
    ...
    def actualizar(self):
        ...
        # cambiamos el sentido de la tuberia en caso de ser necesario UPDATE
