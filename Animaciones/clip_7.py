...
class Pajaro:
    ...
    def __init__(self, x=100, y=350):
        ...
        # bandera del estado del jugador UPDATE
        self.vivo = True
    ...
    def volar(self):
        ...
        if self.vivo and 0 < self.rect.top: # UPDATE
    ...
    def actualizar(self):
        ...
        # evitamos que el pajaro salga de pantalla al tocar el piso UPDATE
        self.rect.y = min([self.rect.y, BG_V-20])

        # actualizamos dinamica horizontal si el jugador ha muerto UPDATE
        if not self.vivo:
            self.rect.x -= VEL_H
    ...
    # deteccion de colisiones UPDATE
