...
class Escena:
    def __init__(self, pantalla):
        ...
        # fuente para puntuacion UPDATE
        self.fuente = pg.font.SysFont('consolas', 60)

        # puntuacion de la partida UPDATE
        self.puntuacion = 0
    ...
    def actualizar(self):
        ...
        # actualizamos la puntuacion considerando la frecuencia de tuberias y el estado del jugador UPDATE
